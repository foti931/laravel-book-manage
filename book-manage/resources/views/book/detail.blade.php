        ...
        <div class="container px-5 py-24 mx-auto">
            <div class="lg:w-4/5 mx-auto flex flex-wrap">
                <div class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
                    <h2 class="text-sm title-font text-gray-500 tracking-widest">{{$book->title}}</h2>
                    <h1 class="text-gray-900 text-3xl title-font font-medium mb-4">{{$book->title}}</h1>
                    <div class="flex mb-4">
                        <a class="flex-grow text-indigo-500 border-b-2 border-indigo-500 py-2 text-lg px-1">説明</a>
                        <a class="flex-grow border-b-2 border-gray-300 py-2 text-lg px-1">レビュー</a>
                        <a class="flex-grow border-b-2 border-gray-300 py-2 text-lg px-1">詳細</a>
                    </div>
                    ...
                    <div class="flex">
                        ...
                        <button class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">レビューを書く</button>
